...
/**
 * Maneja la suscripción de un cliente a una zona para ver capitanes cercanos
 */
async function handleSubscribeToZone(socket, user, customerCoords, getNearbyCaptainsFromRedis) {
  ...
  try {
    const nearbyCaptains = await getNearbyCaptainsFromRedis(
...
/**
 * Maneja la búsqueda de capitanes para un ride
 */
...
/**
 * Maneja la solicitud de un delivery por parte del cliente
 */
async function handleRequestDelivery(socket, io, user, deliveryData, deliveryToCaptains, activeSockets, getNearbyCaptainsFromRedis) {
  try {
    ...
    let nearbyCaptains;
    try {
      nearbyCaptains = await getNearbyCaptainsFromRedis(
...
/**
 * Maneja la suscripción a un delivery específico
 */
...
/**
 * Maneja la suscripción a las órdenes de una tienda
 */
