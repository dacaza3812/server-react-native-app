...
const updateCaptainProfile = async (req, res) => {
  ...
  try {
    ...
    if (name !== undefined) captain.profile.name = name;
    if (lastName !== undefined) captain.profile.lastName = lastName;
    if (email !== undefined) captain.profile.email = email;
    if (avatarUrl !== undefined) captain.profile.avatarUrl = avatarUrl;
    if (dni !== undefined) captain.profile.dni = dni;
