...
const { calculateDistance, calculateDeliveryFee, generateOTP, getNearbyCaptainsFromRedis, } = require("../utils/mapUtils");
const createDelivery = async (req, res) => {
    ...
    const deliveryDistance = calculateDistance(pickupAddress.latitude, pickupAddress.longitude, deliveryAddress.latitude, deliveryAddress.longitude);
