...
const productV1Schema = new mongoose_1.Schema({
    name: {
        type: String,
        required: true,
        trim: true,
...
productV1Schema.virtual("discountedPrice").get(function () {
    const discountFactor = 1 - (this.discount / 100);
    return this.price * discountFactor;
});
productV1Schema.methods.isOnDiscount = function () {
    return this.discount > 0 && (!this.discountValidUntil || this.discountValidUntil > new Date());
};
productV1Schema.methods.isLowInventory = function () {
    return this.inventory <= this.lowInventoryThreshold;
};
const ProductV1 = mongoose_1.default.model("ProductV1", productV1Schema);
exports.default = ProductV1;
//# sourceMappingURL=ProductV1.js.map