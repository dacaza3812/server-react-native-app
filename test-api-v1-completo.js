...
async function testProducts() {
  ...
  // Test 7: Create a product (food with nutrition facts)
  ...
  // Test 8: Create a product (non-food, without nutrition facts)
...
async function testRides() {
  ...
  // Test 12: Accept ride (as captain) - this will recalculate fare based on captain's price
  if (testData.ride) {
  ...
  // Test 12.5: Update ride status to COMPLETED
  if (testData.ride) {
